...
TOPIC_NAME = 'my-first-topic55'

# Streamlit config
st.set_page_config(page_title="GOKUL's Kafka Real-Time Weather Dashboard", layout="centered")
st.title("The Nilgiris Real-Time Weather Dashboard")
...
if st.session_state.last_weather:
    ...
    temp_celsius = round(weather['temperature'] - 273.15, 2)
